...
jswidgets.PopupHorizontalAlignLookupCall.DATA = [
  [scout.Popup.HorizontalAlign.LEFT, 'left'],
  [scout.Popup.HorizontalAlign.LEFTEDGE, 'leftedge'],
  [scout.Popup.HorizontalAlign.CENTER, 'center'],
  [scout.Popup.HorizontalAlign.RIGHT, 'right'],
  [scout.Popup.HorizontalAlign.RIGHTEDGE, 'rightedge'],
];
